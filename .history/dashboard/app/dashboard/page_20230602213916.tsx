...
const Page = () => {
  ...
  return (
    <LayoutCustom>
      <>
        {isOpenMyChatBots ? (
          <Chatbot setIsOpenMyChatBots={setIsOpenMyChatBots} />
        ) : (
          <>
              ...
              {isCardVisible ? (
                          ...
                          <div>
                            ...
                            <div className="mt-3 text-center sm:mt-5">
                              ...
                              <div className="mt-2">
                                <p className="text-sm text-gray-500">
                                  ...
                                  votre contenu. automatiquement un chatbot à
                                  partir de votre contenu.
                                </p>
                              </div>
                            </div>
                            <div className="w-full mt-4">
                              <div className="sm:col-span-4">
                                <div className="mt-2">
                                  <div className="mx-auto flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 ">
                                    <input
                                      placeholder="myshop"
                                      name="url"
                                      autoComplete="off"
                ...
                >
                  <div className="w-full bg-white border border-gray-200 rounded-lg shadow">
                    <Tab.Group>
                      <div className="bg-gray-50 border-0 border-b border-gray-200 text-gray-900 text-sm rounded-t-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        <Tab.List className="text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg sm:flex">
                          ...
                          <Tab className="inline-block w-full p-4 rounded-tl-lg bg-gray-50 hover:bg-gray-100 focus:outline-none">
                            <button
                              id="retour-tab"
                              ...
                              <Disclosure>
                                {({ open }) => (
                                  <>
                                    <Disclosure.Button className="flex w-full justify-between rounded-lg bg-gray-50 px-4 py-2 text-left text-sm font-medium text-purple-900 hover:bg-indigo-100 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75">
                                      <span>
                                        Ajouter le code dans votre page
                                      </span>
                                      <AiOutlineDown
                                        className={`${
                                          open ? "rotate-180 transform" : ""
                                    ...
                                    <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                                      <pre>
                                        Collez le code MyAiChat ci-dessus dans
                                        votre page.
                                      </pre>
                                      <pre className="mb-4">
                                        {
