            ...
            <div className="p-20 mx-auto w-full overflow-y-auto">
                ...
                <dl
                    ...
                    <div className="px-6 py-5 sm:p-8 flex items-center justify-center gap-2">
                        <Link href="https://billing.stripe.com/p/login/3cs4jw2kp1fkdMccMM" target="_blank" className="text-xs font-normal text-blue-600">{translations.MANAGE_SUBSCRIPTION}</Link>
                    </div>
                </dl>
            </div>
        </LayoutCustom>
