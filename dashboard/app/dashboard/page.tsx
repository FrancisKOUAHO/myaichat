...
import {AiOutlinePlus,AiOutlineFolderAdd,AiOutlineCloseCircle} from "react-icons/ai";
      ...
      <div className="w-full overflow-y-auto">
        ...
        <div className="p-40 mx-auto">
          <div className="text-center">
            ...
            <div className="mt-6">
              <div>
                <button  onClick={openModal} className="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
