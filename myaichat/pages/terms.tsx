    ...
    return (
        ...
        >
            <h1 className="text-center text-xl lg:text-3xl font-bold my-10">
                {translations.termsAndConditions.title}
            </h1>
            <div className="text-lg">
                <p>{translations.termsAndConditions.introduction}</p>
                {/* Assume there are multiple sections like in the Privacy Policy example */}
                <h2 className="text-lg lg:text-xl font-semibold mt-5">
                    {translations.termsAndConditions.section1.title}
                </h2>
                <p>{translations.termsAndConditions.section1.content}</p>

                <h2 className="text-lg lg:text-xl font-semibold mt-5">
                    {translations.termsAndConditions.section2.title}
                </h2>
                <p>{translations.termsAndConditions.section2.content}</p>
